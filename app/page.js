...
const Login = () => {
  return (
    <div className="flex flex-col gap-4 w-screen h-screen justify-center items-center ">
      <div className="flex flex-col gap-6 items-center bg-zinc-950">
        <Image
          src="/images/logo/flex-logo-white.svg"
          width={130}
          height={200}
          alt="logo"
        />
        <div className="flex flex-col gap-2">
          <div className="flex flex-col gap-1">
            <p className="text-sm font-semibold text-centerq">
              Username / Email
            </p>
            <input className="bg-zinc-900 rounded  py-1 px-2" />
          </div>
          <div className="flex flex-col gap-1">
            <p className="text-sm font-semibold text-centerq">Password</p>
            <input className="bg-zinc-900 rounded  py-1 px-2" />
          </div>
        </div>

        <button
          className="bg-white text-black rounded py-1 px-4"
...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col w-full h-screen justify-center items-center ">
      {/* Header Bar */}
      <div className="flex items-center w-full text-lg p-10">
        <Image
          src="/images/logo/flex-logo-white.svg"
          width={90}
          height={200}
      ...
      <div className="flex w-full h-screen ">
        {/* Navigation Sidebar */}
        {/* <div className="flex-1 max-w-[200px] p-10"> Nav</div> */}
        {/* Content Area */}
...
export default function Home() {
  ...
  return <>{userLoggedIn ? <Dashboard /> : <Login />}</>;
}
